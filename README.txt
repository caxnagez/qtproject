...
(Здесь можно вставить диаграмму, если у вас есть подходящая схема архитектуры вашего приложения, аналогично примеру в оригинальном README)
...
Приложение предоставляет удобный интерфейс для работы с рецептами:
